...
const SUPPORT_LINKS = [
  ...
  { label: "Valuation & Return Policy", to: "/faq" },
];
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-blue-950/40 to-slate-900/60 border border-blue-900/30 shadow-lg flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="text-white font-black text-sm tracking-tight">4.9 / 5.0</span>
            ...
            <div className="space-y-2.5 pt-1 text-xs">
              <div className="flex items-center gap-3 text-slate-400">
                ...
                <span>support@secondsale.in</span>
              </div>
              <div className="flex items-center gap-3 text-slate-400">
