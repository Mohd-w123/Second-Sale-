    ...
    <div className={`mb-4 ${className}`}>
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          className={`w-full py-2.5 pr-11 border-[1.5px] rounded-xl text-sm font-[DM_Sans] text-text-primary outline-none bg-[#F4F9FA] transition-all duration-200
            focus:border-primary focus:shadow-[0_0_0_3px_rgba(8,127,140,0.12)] focus:bg-white
            ${icon ? 'pl-10' : 'pl-4'}
