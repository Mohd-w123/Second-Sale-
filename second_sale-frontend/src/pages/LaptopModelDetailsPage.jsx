    ...
    <div className="max-w-[900px] mx-auto px-4 sm:px-8 py-8 sm:py-12">
      ...
      <div className="mb-10">
        ...
        <p className="text-[13px] text-gray-500 font-bold max-w-2xl leading-relaxed opacity-80">
          SecondSale helps you sell your used {device.modelName} Laptop online with instant price checks, free doorstep pickup, and secure payment after verification.
        </p>
      </div>
