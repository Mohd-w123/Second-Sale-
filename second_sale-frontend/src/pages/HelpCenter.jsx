...
export default function HelpCenterPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      <SEOHead
        title="SecondSale Help Center — FAQs & Support"
        description="Contact SecondSale support for help selling your old phone, laptop, or tablet. Phone, email, and WhatsApp support available across India."
        path="/help-center"
        schema={schema}
      />
            ...
            <div className="p-10">
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div>
                  ...
                  <input type="text" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB]" placeholder="Your name" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
                  <input type="email" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB]" placeholder="your@email.com" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Message</label>
                  <textarea rows="4" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB]" placeholder="How can we help you?"></textarea>
                </div>
                <button type="submit" className="w-full bg-[#2563EB] text-white font-bold rounded-xl py-3 hover:bg-blue-700 transition duration-200">
                  Send Message
                </button>
              </form>
            </div>
