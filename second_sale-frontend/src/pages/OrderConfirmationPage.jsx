      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-[40px] border border-gray-100 p-8 sm:p-10 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
          <div className="flex flex-col sm:flex-row items-center gap-8">
            <div className="w-20 h-20 bg-[#2563EB] rounded-full flex items-center justify-center text-white shrink-0 shadow-xl shadow-blue-100">
          ...
          <div className="bg-[#E6F4FF] p-6 rounded-[32px] border border-[#2563EB]/10 max-w-xs relative group">
            <div className="absolute -top-3 -right-3 w-6 h-6 bg-[#2563EB] rounded-full flex items-center justify-center border-4 border-white">
            ...
            <button className="w-full bg-[#2563EB] text-white py-3.5 rounded-2xl font-black text-sm hover:bg-[#1D4ED8] transition-all flex items-center justify-center gap-2">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="bg-white rounded-[40px] border border-gray-100 p-8 sm:p-10 shadow-sm relative">
              <div className="flex items-center justify-between mb-8">
                ...
                <Link to={`/orders/${orderId}`} className="text-[#2563EB] font-black text-sm bg-[#E6F4FF] px-5 py-2.5 rounded-xl border border-[#2563EB]/10 hover:bg-[#2563EB] hover:text-white transition-all">
                  Track Order
                </Link>
              </div>
              ...
              <div className="bg-gray-50/50 rounded-[32px] p-8 sm:p-10 border border-gray-100/50 flex flex-col md:flex-row items-center gap-10">
                ...
                <div className="flex-1 text-center md:text-left">
                  <span className="text-[#2563EB] text-[10px] font-black uppercase tracking-[2px] mb-2 block">Final Value</span>
                  ...
                  <div className="flex items-center gap-3 bg-[#E6F4FF] px-4 py-3 rounded-2xl border border-[#2563EB]/10">
                    <div className="w-5 h-5 bg-[#2563EB] rounded-full flex items-center justify-center text-white shrink-0">
                  ...
                  >
                    <div className="mt-6 flex flex-col gap-2">
                       ...
                       <div className="flex gap-2">
                         <input type="text" placeholder="Enter your UPI ID (e.g., name@upi)" className="flex-1 bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 text-sm font-bold focus:outline-none focus:border-[#2563EB]" />
                         <button className="bg-[#2563EB] text-white px-6 py-3 rounded-xl font-black text-xs flex items-center gap-2">
          ...
          <div className="w-full lg:w-96 space-y-6">
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <div className="w-12 h-12 bg-[#E6F4FF] rounded-2xl flex items-center justify-center text-[#2563EB] shrink-0 border border-[#2563EB]/5">
            ...
            <div className="bg-white rounded-[40px] border border-gray-100 p-8 shadow-sm">
              ...
              <button className="w-full bg-[#2563EB] text-white py-4 rounded-2xl font-black text-sm hover:bg-[#1D4ED8] transition-all shadow-lg shadow-blue-50">
                Contact Support
              </button>
            </div>
          </div>
...
function PaymentCard({ label, desc, icon, active, onClick, children, expanded }) {
  return (
    <div className={`p-6 rounded-[32px] border-2 transition-all ${active ? 'border-[#2563EB] bg-[#E6F4FF]' : 'border-gray-50 bg-gray-50/50 hover:border-gray-200'} cursor-pointer`} onClick={onClick}>
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
           <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${active ? 'bg-[#2563EB] text-white' : 'bg-white text-gray-400'}`}>
             {icon}
           </div>
           <div>
        ...
        <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${active ? 'border-[#2563EB] bg-[#2563EB]' : 'border-gray-200'}`}>
...
function ActionLink({ to, icon, label }) {
  return (
    <Link to={to} className="flex items-center justify-between p-4 rounded-2xl hover:bg-gray-50 transition-all group">
      ...
      <svg className="text-gray-300 group-hover:text-[#2563EB] transition-all group-hover:translate-x-1" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M9 18l6-6-6-6"/></svg>
    </Link>
  );
}
