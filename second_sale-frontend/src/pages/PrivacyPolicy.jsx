...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="min-h-screen bg-white py-16 px-4 sm:px-6 lg:px-8">
      <SEOHead
        title="Privacy Policy — SecondSale"
        description="SecondSale privacy policy. Learn how Swastika Innovation Private Limited collects, uses, and protects your personal information."
        path="/privacy-policy"
        schema={schema}
      />
