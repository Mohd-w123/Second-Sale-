  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 sm:px-8 py-10 sm:py-16">
      <CategoryPageSEO
        ...
        description={`Sell your used ${brandName} phone online with SecondSale. Get instant quotes, free doorstep pickup, and secure payment across India.`}
        path={path}
      ...
      {filtered.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5">
          {filtered.map(model => (
            ...
            >
              {/* Image Container */}
              <div className="bg-gray-50 rounded-xl h-28 sm:h-36 flex items-center justify-center mb-4 group-hover:bg-[#2563EB]/5 transition-colors">
                {model.imageUrl ? (
