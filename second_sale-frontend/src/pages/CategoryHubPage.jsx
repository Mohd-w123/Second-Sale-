    ...
    <>
      ...
      <div className="max-w-[900px] mx-auto px-4 py-12 sm:py-20">
        ...
        <div className="prose prose-sm max-w-none text-gray-600 mb-8 space-y-4">
          <p>
            SecondSale makes it simple to sell your used {hub.keywords[0]} in India. Our smart pricing algorithm gives you a fair, transparent quote based on your device model, storage, and condition — with no last-minute haggling at pickup.
          </p>
          <p>
            Once you accept the quote, schedule a free doorstep pickup at a time that works for you. A verified SecondSale agent will inspect your device, and you'll receive instant payment via UPI, bank transfer, or cash after verification.
          </p>
          <h2 className="text-xl font-black text-gray-900">How pricing works</h2>
          <p>
            Your final price depends on the exact model, storage variant, physical condition, and functional status. Answer our condition quiz honestly for the most accurate quote. SecondSale serves customers across 2,000+ cities in India.
          </p>
        </div>

        <Link
          to={hub.path}
          className="inline-flex btn-gradient text-white font-bold px-6 py-3 rounded-xl transition-all no-underline mb-10 shadow-md shadow-[#087F8C]/20"
        >
          Get instant quote →
        </Link>
