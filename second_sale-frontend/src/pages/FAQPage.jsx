...
export default function FAQPage() {
  ...
  return (
    <>
      <SEOHead
        title="SecondSale FAQs — Sell Old Devices Online in India"
        description="Find answers about selling old phones, laptops, tablets and iMac on SecondSale. Pricing, free pickup, payment methods, and Cashify alternatives explained."
        path="/faq"
        schema={schema}
      />
