      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-[40px] border border-gray-100 p-8 sm:p-12 shadow-sm space-y-12">
          ...
          <div className="flex flex-wrap gap-y-2 gap-x-8 text-sm font-bold">
            ...
            <p className="text-[#087F8C]">Pickup Date: <span className="font-black">{pickupDateStr} - {order.pickup?.timeSlot}</span></p>
          </div>

          <div className="border-t border-gray-50 pt-10">
            <h3 className="text-lg font-black text-[#111827] mb-10">Order Status: <span className="text-[#087F8C]">Generated</span></h3>

            {/* Progress Bar */}
            <div className="relative pt-12 pb-8">
              <div className="absolute top-[60px] left-0 right-0 h-1 bg-gray-100 rounded-full" />
              <div
                className="absolute top-[60px] left-0 h-1 bg-gradient-to-r from-[#116466] via-[#087F8C] to-[#0EA5E9] rounded-full transition-all duration-500"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-10 border-t border-gray-50">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xs font-bold text-gray-400 mb-3">Payment Type : <span className="text-[#087F8C] capitalize">{order.pickup?.paymentMethod}</span></p>
                {['placed', 'scheduled'].includes(order.status) && (
                  <button
                    onClick={() => setShowUpdatePayment(true)}
                    className="text-xs font-black text-[#087F8C] border border-[#087F8C] rounded-xl px-4 py-2 hover:bg-[#087F8C] hover:text-white transition-all shadow-sm"
                  >
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xs font-bold text-gray-400 mb-4">Pickup Status: <span className="text-[#087F8C]">Order Generated</span></p>
                  ...
                  {['placed', 'scheduled'].includes(order.status) && (
                    <>
                      <button
                        ...
                        className="flex items-center gap-2 bg-[#E8F6F7] text-[#087F8C] px-6 py-2.5 rounded-xl font-black text-xs hover:bg-[#087F8C] hover:text-white transition-all shadow-sm"
                      >
              ...
              <div>
                ...
                <div className="space-y-3 bg-white p-6 rounded-2xl border border-gray-50 shadow-sm">
                  ...
                  <div className="flex justify-between text-xs font-bold text-gray-400">
                    <span>Pickup</span>
                    <span className="text-[#087F8C]">FREE</span>
                  </div>
        ...
        <div className="space-y-6">
              ...
              {dates.map(date => (
                <button
                  ...
                  className={`py-3 rounded-xl border text-xs font-black transition-all
                    ${selectedDate === date ? 'bg-[#087F8C] text-white border-[#087F8C]' : 'bg-gray-50 text-gray-500 border-gray-100 hover:border-gray-200'}`}
                >
              ...
              {slots.map(slot => (
                <button
                  ...
                  className={`w-full py-4 px-6 rounded-2xl border text-sm font-black transition-all text-left flex items-center justify-between
                    ${selectedSlot === slot ? 'bg-[#E8F6F7] text-[#087F8C] border-[#087F8C]' : 'bg-gray-50 text-gray-500 border-gray-100 hover:border-gray-200'}`}
                >
                  {slot}
          ...
          <div className="flex gap-4 pt-4">
            ...
            <button
              ...
              className="flex-2 btn-gradient text-white font-black py-4 px-8 rounded-2xl cursor-pointer transition-all disabled:opacity-50"
            >
  ...
  return (
    <div className="flex items-center justify-between group cursor-pointer">
      <div className="flex items-center gap-3">
        <div className="w-6 h-6 rounded-full border border-gray-100 flex items-center justify-center text-gray-400 group-hover:text-[#087F8C] transition-colors">
      ...
      <svg className="text-gray-300 group-hover:text-[#087F8C] group-hover:translate-x-0.5 transition-all" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M7 17l10-10M7 7h10v10" /></svg>
    </div>
  );
}
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-2xl rounded-[40px] shadow-2xl p-10 max-h-[90vh] overflow-y-auto no-scrollbar">
        ...
        <button
          ...
          className="w-full mt-8 bg-[#087F8C] text-white font-black py-5 rounded-[24px] hover:bg-[#066772] transition-all shadow-xl shadow-[#087F8C]/20 disabled:opacity-50"
        >
      ...
      <div className="relative bg-white w-full max-w-md rounded-[40px] shadow-2xl p-10 max-h-[90vh] overflow-y-auto no-scrollbar">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-6 btn-gradient text-white font-black py-5 rounded-[24px] cursor-pointer hover:bg-[#066772] transition-all shadow-xl shadow-[#087F8C]/20 flex items-center justify-center gap-2"
          >
