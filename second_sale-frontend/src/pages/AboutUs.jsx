...
export default function AboutUs() {
  ...
  const schema = buildSchemaGraph([
    organizationSchema({
      founder: [
        ...
        { '@type': 'Person', name: 'SecondSale Founder', jobTitle: 'Founder' },
      ],
    }),
    websiteSchema(),
  ]);
  ...
  return (
    <div className="w-full bg-white">
      ...
      {/* ── VISION & MISSION ── */}
      <section className="py-10 sm:py-16 bg-gradient-to-b from-white to-[#F7FAFF] border-t border-gray-50">
        <div className="max-w-[1200px] mx-auto px-4">
        ...
        <div className="max-w-[1200px] mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
            ...
            <div className="bg-white rounded-[28px] p-8 sm:p-10 border border-gray-100 shadow-md flex flex-col justify-between hover:shadow-xl transition-all duration-300">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mb-6 font-medium leading-relaxed">
                  Aditya Sekhar is a business leader, entrepreneur, and one of the youngest research scholars in Smart Cities. As the Chairman of Micro Cloud Computing Pvt. Ltd., he brings strong leadership and strategic vision to SecondSale.
                </p>
              ...
              <div className="mt-8 pt-6 border-t border-gray-50 flex items-center gap-3 text-xs sm:text-sm font-semibold text-gray-400">
                <Briefcase size={16} /> Chairman & Co-Founder, SecondSale
              </div>
            </div>
            ...
            <div className="bg-white rounded-[28px] p-8 sm:p-10 border border-gray-100 shadow-md flex flex-col justify-between hover:shadow-xl transition-all duration-300">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    "Brings 5+ years of experience in e-commerce, founding SecondSale to make buying and selling electronics simple, transparent, and reliable.",
              ...
              <div className="mt-8 pt-6 border-t border-gray-50 flex items-center gap-3 text-xs sm:text-sm font-semibold text-gray-400">
                <Briefcase size={16} /> Founder, SecondSale
              </div>
            </div>
      ...
      <section className="py-12 bg-[#F7FAFF] border-t border-gray-100">
