...
const FAQ = {
  ...
  a: 'SecondSale is among the best places to sell old phones in India, offering instant online quotes, free doorstep pickup in 2,000+ cities, and immediate payment via UPI or bank transfer after device verification.',
};

const PLATFORMS = [
  { name: 'SecondSale', type: 'Buyback platform', bestFor: 'Instant cash, free pickup, no haggling', link: '/sell-old-mobile-phones/brand' },
...
export default function BestPlaceToSellPhone() {
  ...
  return (
    <>
      <SEOHead
        title="Best Place to Sell Old Phone in India (2026) — SecondSale"
        description="Discover the best place to sell your old phone in India. Compare buyback platforms and learn why SecondSale offers instant quotes, free pickup, and transparent pricing."
      ...
      <div className="max-w-[900px] mx-auto px-4 py-12 sm:py-20">
        ...
        <p className="text-gray-500 mb-8 leading-relaxed">
          Selling your old smartphone in India has never been easier. Online buyback platforms like SecondSale let you get an instant quote, schedule free pickup from home, and receive payment within minutes — without visiting a shop or haggling with buyers.
        </p>
        ...
        <div className="space-y-4 mb-10">
          {PLATFORMS.map((p) => (
            <div key={p.name} className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 p-4 bg-white border border-gray-100 rounded-xl">
              ...
              {p.link && (
                <Link to={p.link} className="text-[#087F8C] font-bold text-sm whitespace-nowrap hover:underline">
                  Sell now →
                </Link>
              )}
            </div>
        ...
        <div className="bg-[#E8F6F7] rounded-2xl p-6 mb-8">
          ...
          <Link
            ...
            className="inline-flex mt-4 btn-gradient text-white font-bold px-6 py-3 rounded-xl shadow-md shadow-[#087F8C]/20 transition-colors no-underline"
          >
            Get instant quote
          </Link>
        </div>
