...
export default function TermsAndConditionsPage() {
  ...
  return (
    <div className="min-h-screen bg-white py-16 px-4 sm:px-6 lg:px-8">
      <SEOHead
        title="Terms & Conditions — SecondSale"
        description="SecondSale terms and conditions for selling old devices online in India. Operated by Swastika Innovation Private Limited."
